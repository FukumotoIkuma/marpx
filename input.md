...
size: 16:9
paginate: true
header: Visual QA Deck
footer: marp-to-pptx manual review
style: |
  section {
...
<!-- _class: lead -->
<!-- note: This deck is for optional human review. Compare the generated PPTX against the Marp rendering and report any visual mismatch. -->

# Visual QA Deck
## marp-to-pptx manual comparison input

- Purpose: compare Marp HTML and generated PPTX side by side
...
1. Check text content, line breaks, emphasis, and alignment.
2. Check lists, nested levels, and numbered ordering.
3. Check tables, merged cells, and cell background fills.
4. Check image sizing, aspect ratio, background images, and SVG rendering.
5. Check fallback content such as raw SVG and MathJax.

<div class="grid-3">
  <div class="card">
    <div class="badge">Good</div>
    <p>Position matches, spacing is close, and text remains readable.</p>
  </div>
  <div class="card">
    <div class="badge">Watch</div>
    <p>Aspect ratio drift, missing bullets, or line wrapping changes.</p>
  </div>
  <div class="card">
    <div class="badge">Fail</div>
    <p>Missing content, severe overlap, or fallback not rendered.</p>
  </div>
</div>
...
Inline code should still look distinct: `uv run marp-to-pptx input.md -o output.pptx`
...
<!-- _header: Visual QA Deck / Background Color -->
...
<!-- note: Final reminder note. Human testers can write feedback directly against slide numbers from this deck. -->
