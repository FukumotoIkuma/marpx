...
_PASSTHROUGH_FONTS: set[str] = {
    ...
    "arial", "calibri", "cambria", "candara", "century gothic",
    ...
    "avenir", "avenir next", "futura", "gill sans", "helvetica",
    "helvetica neue", "menlo", "monaco", "optima", "palatino",
    "san francisco", "sf pro", "sf mono",
    # Common cross-platform
    "roboto", "open sans", "lato", "montserrat", "source sans pro",
    "source code pro", "noto sans", "noto serif", "fira code", "fira sans",
    # CJK fonts
